...
public class VisualAcuityTest extends BaseTest {
	...
	public void validateFullVisualAcuityAndRefractionFlow() {
		...
		try {
			...
			clinical.searchByDate("02/06/2026", "30/09/2026");
			...
			visual.fillVisualAcuityForm(spectacles, years, months, purpose,
...
//             // ===== OPEN PATIENT =====
//             ClinicalPage clinical = new ClinicalPage(driver);
//             clinical.searchByDate("02/07/2026", "30/09/2026");
//             clinical.clickValidRecord();
//             System.out.println("✅ Patient opened");

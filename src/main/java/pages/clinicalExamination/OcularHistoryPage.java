...
public class OcularHistoryPage extends BasePage {
 ...
 private By systemicSaveButton = By.id("CE_btnAddUpdateSystemicDiseases");
    ...
    // Handle both visible text and value
    switch (value.toLowerCase()) {
        case "yes":
            select.selectByValue("1"); // backend value
            break;
        case "no":
        ...
        case "-1":
            ...
            break;
        default:
            // fallback: try visible text directly
            select.selectByVisibleText(value);
            break;
    }

    System.out.println("🟢 Selected Any Of: " + value);
}
 ...
 public void clickSystemicSaveButton() {
	...
	handleSuccessPopup(); // reuse existing popup handler
	}
